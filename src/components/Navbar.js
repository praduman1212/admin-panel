...
const Navbar = () => {
    ...
    return (
        <>
            {/* Only render navbar on sm+ screens, nothing on mobile */}
            <nav className="hidden sm:block fixed top-0 right-0 left-0 h-16 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 z-40">
                <div className="flex h-full flex-row items-center justify-between px-4 md:px-5 gap-0 w-full">
                    {/* Logo and admin name (sm+) */}
                    ...
                    {/* Search Bar */}
                    <div className="relative flex-1 w-full max-w-xl mx-4 my-0 order-none">
                        <div className="relative flex items-center border-2 border-[#8d95ab] rounded-lg bg-white dark:bg-gray-900">
                            ...
                            <input
                                ...
                                placeholder="Search..."
                                className="w-full pl-10 pr-10 py-2 rounded-lg bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-base"
                            />
                            {/* Microphone Button */}
                            <button
                                type="button"
